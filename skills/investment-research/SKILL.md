...
| 恐慌指数/VIX/宏观风险 | sentiment-analysis | web-search |
| 预测市场/Polymarket/地缘政治 | sentiment-analysis | web-search |
...
5. **舆情和宏观风险用 sentiment-analysis**: 微观舆情（个股新闻+情感分析+事件信号）和宏观风险（VIX恐慌指数+10年期国债+Polymarket预测市场）均在此技能中
